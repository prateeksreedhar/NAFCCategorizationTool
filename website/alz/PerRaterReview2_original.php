<?php
    ...
    $handle = fopen("rater_2500_test.csv", "w");
                    ...
                    {   echo "\n sol count: ".$solCount;
                        ...
                        {   $num = $index + 1;
                            ...
                            {   $row0 = mysqli_fetch_row($res0);
                                $str = "Solution,$count.$solCount,". $sCat[$raters[0]][$index][$subIndex] .",". $sCat[$raters[1]][$index][$subIndex] .",". $sCat[$raters[2]][$index][$subIndex] .",". $num ."". $subIndex .",". $row0[0] ."\n";
                                fwrite($handle, $str);
                            }
                            else
                                echo mysqli_error($connect);
